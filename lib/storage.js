...
// - Vercel/Netlify (sem disco gravável persistente): sem banco no servidor;
//   o navegador continua guardando os registros localmente (IndexedDB).
// Veja também schema.sql: descreve, em formato de banco relacional, a mesma
// estrutura de dados usada aqui (registro -> ocorrências -> anexos). É só
// documentação/referência — este módulo não lê nem grava nele.
...
async function createBackend() {
  ...
  if (forced === "none" || process.env.VERCEL || process.env.NETLIFY) return noneBackend();
